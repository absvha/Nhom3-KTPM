...
class TestTC030():
    ...
    def test_tC030(self):
        ...
        # 3. Nhập các trường hợp lệ (BỎ TRỐNG SỐ ĐIỆN THOẠI)
        self.slow_send_keys(
        ...
        # ❌ KHÔNG nhập Số điện thoại (đúng TC030)
        ...
        # Chỉ cần hệ thống báo lỗi liên quan đến SĐT
        assert "điện thoại" in thong_bao.lower()
