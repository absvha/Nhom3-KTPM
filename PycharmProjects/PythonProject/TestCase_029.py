...
class TestTC029():
    ...
    def test_tC029(self):
        ...
        # 3. Nhập các trường hợp lệ (BỎ TRỐNG EMAIL)
        self.slow_send_keys(
        ...
        # Chỉ cần hệ thống báo lỗi liên quan đến Email
        assert "email" in thong_bao.lower()
