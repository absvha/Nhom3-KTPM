...
class TestTC036():
    ...
    def test_tC036(self):
        ...
        self.driver.find_element(By.ID, "ContentPlaceHolder1_txtTaiKhoan").send_keys("HaiYen12131213")
        ...
        # Lấy nội dung thông báo và loại bỏ khoảng trắng thừa bằng .strip()
        ...
        # Xác nhận hệ thống báo đúng lỗi mong đợi
