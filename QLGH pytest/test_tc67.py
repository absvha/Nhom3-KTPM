...
def test_tc67(driver):
    ...
    el = wait_find(driver, 'id=ContentPlaceHolder1_DataList1_Image1_0')
    ...
    from conftest import wait_click
    wait_click(driver, 'id=ContentPlaceHolder1_gvGioHang_txtSoLuong_0')
    from conftest import wait_find
    el = wait_find(driver, 'id=ContentPlaceHolder1_gvGioHang_txtSoLuong_0')
    el.clear()
    el.send_keys('-1')
    from conftest import wait_click
    wait_click(driver, 'css=td:nth-child(8) > .bt-style-chucnang')
