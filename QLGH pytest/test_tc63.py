...
def test_tc63(driver):
    ...
    from conftest import wait_click
    wait_click(driver, 'id=ContentPlaceHolder1_DataList1_Image1_1')
    from conftest import wait_find
    # el = wait_find(driver, 'id=ContentPlaceHolder1_Datalist1_txtSoLuong_0')
    # ActionChains(driver).move_to_element_with_offset(el, 14.33331298828125, 23.0).click_and_hold().perform()
    # from conftest import wait_find
    # el = wait_find(driver, 'id=ContentPlaceHolder1_Datalist1_txtSoLuong_0')
    # ActionChains(driver).move_to_element_with_offset(el, 14.33331298828125, 23.0).perform()
    # from conftest import wait_find
    # el = wait_find(driver, 'id=ContentPlaceHolder1_Datalist1_txtSoLuong_0')
    # ActionChains(driver).move_to_element_with_offset(el, 14.33331298828125, 23.0).release().perform()
    # from conftest import wait_click
